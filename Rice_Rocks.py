...
def draw(canvas):
    global time, started, lives, score, time_variable, rock_limit
...
def rock_spawner():
    global a_rock, rock_group, rock_limit
...
def group_collide(group, other_sprite):
    ...
    for i in group:
        if i.collide(other_sprite) == True:
            group.discard(i)
...
timer = simplegui.create_timer(time_variable, rock_spawner)
